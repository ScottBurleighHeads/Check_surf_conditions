...
class Test_Surf(unittest.TestCase):
    ...
    def test_surf_str_entry(self):
        ...
        self.assertEqual(Test_Surf.value_input(1.5,"S",10,None).surf_str_entry,"decent swell but onshore.")
...
#   unittest.main()             # This feature will allow you to run the command in the terminal without the 